...
const CC3 = (props) => {
    ...
    const [hostedPoint, setHostedPoint] = useState();
    ...
    function next() {
        ...
        if(hostedPointTitle == ''){
            alertRef.alertWithType('error','Error','Please select experience')
            return;
        }
    ...
    const ErrorPopupModal = () => (
        ...
        >
            <View style={{ backgroundColor: 'white', paddingHorizontal: 20, paddingTop: 25, paddingBottom: 10, borderRadius: 20 }}>
                <Text style={[styles.popupHeading]}>Sorry! We’re seeking
                    hosts with experience
                    doing this. Find a co-host
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            />
            <HappeningHeader
                heading={"Have you experience in hosting a project? "}
                ...
                <ScrollView>
                    <View style={{ width: '90%', alignSelf: 'center', }}>
                        <Image
                            ...
                            source={require('../../../../static_assets/pic4.png')}
                        />
