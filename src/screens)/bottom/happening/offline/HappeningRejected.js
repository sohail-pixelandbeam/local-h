        ...
        <View style={{ flex: 1, backgroundColor: '#35208E' }}>
            ...
            <View style={{ width: "85%", alignSelf: 'center' }}>
                <Image
                    ...
                    source={require('../../../../assets/happeningRejected.png')}
                />
                <ScrollView contentContainerStyle={{ paddingBottom: 150 }}>
                    <Text style={{ fontSize: 29, color: 'white', fontFamily: fonts.PBo, marginTop: 50 }}>Uh,Oh!{"\n"}Your Happening{"\n"}got rejected</Text>
                    <Text style={{ fontSize: 29, color: '#A69FD9', fontFamily: fonts.PBo, marginTop: 10 }}>Upon careful consideration{"\n"}your happening has been{"\n"}rejected.</Text>
                    <Text style={{ fontSize: 14, color: '#A69FD9', fontFamily: fonts.PMe }}>You happening submission seems to have  not met the requirements for an Ideal happening on the platform, please check your email to see the reasons for rejection, and how to resubmit</Text>
                </ScrollView>
            </View>
...
export default HappeningRejected
