    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={styles.contentContainer}>
                ...
                <ScrollView>
                    <Text style={{ color: '#2A2A2A', fontSize: 15, fontFamily: fonts.MBo, marginTop: 20 }}>Here are some good recommendations for titles</Text>
                    <FlatList
                        data={[
                            { img: require('../../../../static_assets/pic6.png'), title: 'Restore coral reefs in open sea' },
                            { img: require('../../../../static_assets/pic6.png'), title: 'Fight Food Waste With Local Communities' }
                        ]}
                        renderItem={({ item }) => (
