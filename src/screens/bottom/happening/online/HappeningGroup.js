...
const HappeningGroup = (props) => {
    ...
    const [minAgeToParticipate, setMinAgeToParticipate] = useState(state.happeningDraft?.minAgeToParticipate??'');
    const [minPeopleRequiredForTheHappenig, setMinPeopleRequiredForTheHappenig] = useState(state?.happeningDraft?.minPeopleRequiredForTheHappenig??'');
    const [maxPeopleAllowedAtAGivenTime, setMaxPeopleAllowedAtAGivenTime] = useState(state?.happeningDraft?.maxPeopleAllowedAtAGivenTime??'');
    const [maxPeopleThatAFellowCanBring, setMaxPeopleThatAFellowCanBring] = useState(state?.happeningDraft?.maxPeopleThatAFellowCanBring??'');
    const [fellowMustComeAlone, setFellowMustComeAlone] = useState(state?.happeningDraft?.fellowMustComeAlonefalse??false);
...
//             maxPeopleThatAFellowCanBring: fellowMustComeAlone ? 0 : maxPeopleThatAFellowCanBring,
//             fellowMustComeAlone: fellowMustComeAlone,
