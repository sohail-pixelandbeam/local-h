...
const EditTitle = (props) => {
    ...
    const [title, setTitle] = useState(props.route.params?.happeningTitle);
    const [titleWords, setTitleWords] = useState(0);

    console.log('props.route.params?.happeningTitle', props.route.params?.happeningTitle)
    ...
    React.useEffect(() => {
        getTitleWordsCount(props.route.params?.happeningTitle)
    }, [])
