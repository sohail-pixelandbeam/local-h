...
const EditSkills = (props) => {
    ...
    const [selectedSkils, setSelectedSkils] = useState(props.route.params?.skillLevel);

    const [skillsArr, setSkillsArr] = useState(props.route.params?.addSkill ?? []); // TO SEND IT TO SERVER
