            ...
            <View style={styles.contentContainer}>
                <ScrollView contentContainerStyle={{ paddingBottom: 350 }} >
                    <View style={{ width: '90%', alignSelf: 'center', }}>
                        ...
                        <Text style={[styles.text, { marginTop: 20 }]}>Please give the host your best effort. Don’t underestimate the value of your assistance to them. Enjoy being in a new environment, meeting new people, and learning about different cultures. But remember that your knowledge and time are extremely valuable to them.</Text>
                    </View>
                </ScrollView>

            </View>
            <HappeningStep
                onPress={() => navigate('ChildrenTeenagers', {
