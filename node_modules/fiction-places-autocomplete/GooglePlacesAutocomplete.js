...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _onPress = (rowData) => {
    ...
    //
    if(rowData.description=="Current location" && rowData.isCurrentLocation)
    {
      
      return this.props.setCurrentLocation(rowData.description);
      
    }
    console.log(rowData);

    if(rowData.description=="Cancel" && rowData.isPredefinedPlace)
    {
    ...
    if(rowData.description=="Select On Map" && rowData.isPredefinedPlace)
    {
      
      return this.props.dropApin(rowData.description);
